...
setup(
  ...
  download_url = 'https://github.com/iamoracle/django_case_insensitive_field/archive/refs/tags/v.1.0.1.tar.gz',    # I explain this later on
  keywords = ['Django', 'Case Insensitive', 'Field', 'How to make Django Field'],   # Keywords that define your package best
  install_requires=[],
  classifiers=[
